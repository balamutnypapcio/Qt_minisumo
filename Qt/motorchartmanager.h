 ...
 * @brief Zarządza wykresem danych z silników.
 */
...
private:
    ...
    QLineSeries* m_series1;        ///< Pierwsza seria danych wykresu (Motor 1).
    QLineSeries* m_series2;        ///< Druga seria danych wykresu (Motor 2).
    QValueAxis* m_axisX;           ///< Oś X wykresu (zwykle czas).
    QValueAxis* m_axisY;           ///< Oś Y wykresu (prędkość silnika).
