 ...
 * @brief Zarządza wykresem danych z czujnika IMU.
 */
...
private:
    ...
    QLineSeries* m_series1;        ///< Pierwsza seria danych wykresu (oś X IMU).
    QLineSeries* m_series2;        ///< Druga seria danych wykresu (oś Y IMU).
    QValueAxis* m_axisX;           ///< Oś X wykresu (zwykle czas).
    QValueAxis* m_axisY;           ///< Oś Y wykresu (wartość IMU).
