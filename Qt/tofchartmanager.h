 ...
 * @brief Zarządza wykresem danych z czujników ToF (Time of Flight).
 */
...
private:
    ...
    QLineSeries* m_series1;        ///< Pierwsza seria danych wykresu (ToF 1).
    QLineSeries* m_series2;        ///< Druga seria danych wykresu (ToF 2).
    QLineSeries* m_series3;        ///< Trzecia seria danych wykresu (ToF 3).
    QLineSeries* m_series4;        ///< Czwarta seria danych wykresu (ToF 4).
    QValueAxis* m_axisX;           ///< Oś X wykresu (zwykle czas).
    QValueAxis* m_axisY;           ///< Oś Y wykresu (stan czujnika).
